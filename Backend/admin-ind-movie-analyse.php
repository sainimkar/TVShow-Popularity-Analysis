    ...
    <div class="content">
        ...
        <div class="animated fadeIn">
            ...
            <div class="row">
                ...
                $sql= "SELECT movie_ratings FROM movies WHERE movie_id='" .  $movie_id. "'";
                ...
                <?php
                $query= "SELECT movie_views FROM movies WHERE movie_id='" .  $movie_id . "'";
                ...
                <?php
                $query= "SELECT movie_sales FROM movies WHERE movie_id='" .  $movie_id . "'";
                $result = mysqli_query($conn,$query)  or die(mysql_error());
                        ...
                        <div class="card-body">
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib">
                                        <div class="stat-text"><span class="count"><?php echo $temp;?></span></div>
                                        <div class="stat-heading">Movie sales</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <?php
                $query = "SELECT COUNT(*) as usercount from ushow_analytics where movie_id='" .  $movie_id . "' GROUP BY user_id ";
                $result = mysqli_query($conn,$query)  or die(mysql_error());
