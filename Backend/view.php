...
<body data-spy="scroll" data-target=".navbar" data-offset="20">
  ...
  <div class="container-fluid" style="margin: 20px; align-content: center; padding: 10px;" id="drama">
      ...
      <h1 style="text-align: center; margin-top: 60px; margin-bottom: 62px;">TOP RATED </h1>
      <div class="container mt-3">
        <div class="row">
         

          <?php
            $query = "SELECT * FROM view  ORDER BY ratings DESC LIMIT 20";
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                            ...
                            <img src="<?php echo $row["image"]; ?>" class="img-responsive">
                                ...
                                <h5 class="text-info"><?php echo $row["id"]; ?></h5>
                                <h5 class="text-danger">AVG RATINGS:<?php echo $row["ratings"]; ?></h5>
                                <a class="btn btn-lg btn-success" href="individualshow.php?showid=<?php echo $row['id']?>"></a>
