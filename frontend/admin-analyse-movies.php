...
<div id="right-panel" class="right-panel" style="margin-top: 35px;">
    <!-- Header-->
    ...
    <div class="container-fluid" style="margin-top: 0px;">
        <table class="table table-striped table-hover">
            ...
            <tbody>
            <?php
            $query = "SELECT movie_id, movie_name,movie_genre from movies";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr> <td>" . $row["movie_id"]. "</td> 
                       ...
                       <td><a class='btn btn-primary btn-lg'  href='admin-ind-movie-analyse.php?movie_id=".$row['movie_id']."'>Analyse</a></td>
                       </tr>";
                }
                echo "</table>";
            }
